        ...
        <div className='p-20'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 pt-20' >
                <div class="flex justify-center">
                    <div class="rounded-lg hover:shadow-2xl hover:bg-base-100 max-w-sm pt-10" data-aos="fade-right">
                        <a href="#!">
                ...
                <div class="flex justify-center sm:my-10 md:my-0">
                    <div class="rounded-lg hover:shadow-2xl hover:bg-base-100 max-w-sm pt-10" data-aos="zoom-in">
                        <a href="#!">
                ...
                <div class="flex justify-center ">
                    <div class="rounded-lg hover:shadow-2xl hover:bg-base-100 max-w-sm pt-10" data-aos="fade-left">
                        <a href="#!">
